package com.hunterdavis.easymouseandratwhistle;
...
public class EasyMouseAndRatWhistle extends Activity { 
    ...
    public void onCreate(Bundle savedInstanceState) {
		...
		OnClickListener dogOneListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 65000);
			}
		};
		...
		OnClickListener dogTwoListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 61750);
			}
		};
		...
		OnClickListener dogThreeListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 67250);
			}
		};
		...
		OnClickListener dogFourListener = new OnClickListener() {
			public void onClick(View v) {
				playFrequency(v.getContext(), 62100);
			}
		};
